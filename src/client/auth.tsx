...
interface AuthState { user: User | null; loading: boolean; login: (e: string, p: string) => Promise<void>; logout: () => void; refreshUser: () => Promise<void> }
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  return <AuthCtx.Provider value={{ user, loading, login, logout, refreshUser }}>{children}</AuthCtx.Provider>;
}
